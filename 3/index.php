...
<html>
 <head>
	...
	<!-- Icon -->
	<link rel="shortcut icon" type="image/icon" href="../aset/foto/logo.png">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
				<li class="header"><h4><b><center>Sidebar</center></b></h4></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>WELCOME TO SIAKAD POLINEMA</b></center></h1><BR><BR><BR><BR><BR>
					<center><img src="../aset/foto/ti.png"></center><BR><BR><BR><BR><BR><BR><BR><BR>
					<center></b></center>
                </div><!-- /.box-header -->
                <div class="box-body">
